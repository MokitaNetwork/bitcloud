...
document.documentElement.style.setProperty('--vh', `${vh}px`); // toggle body theme
...
(function () {
  const category = $('.footer__category'),
        menu = $('.footer__menu');
...
(function () {
  const toggle = $('.notifications__toggle'),
...
(function () {
  const wrapper = $('.js-bargaining-wrapper'),
